...
{
    public class ReporteCtaExternaDto
    {
        public ReporteCtaExternaDto()
        {
        ...
        public class _Detalle
        {
            ...
            public string DescripcionEstadoPreSolicitud { get; set; }
            public string CodigoEstadoPreSolicitud { get; set; }
            public string SubTipoCreditoDesc { get; set; }
        }
    }
}